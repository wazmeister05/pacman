...
public final class Constants
{
	...
	public static final int MAX_TIME=Integer.MAX_VALUE;      //maximum time a game can be played for
	...
	public static final int DELAY=100;						//delay (in milliseconds) between game advancements
